...
@property (nonatomic, strong) TWGroupInfo *groupInfo;
@property (nonatomic, strong) TWFriendInfo *friendInfo;
 ...
 *  服务号按钮被点击
 *
 *  @param messageToolBar
 *  @param serveButton    
 */
- (void)messageToolBar:(DXMessageToolBar *)messageToolBar didServeButtonClicked:(UIButton *)serveButton;
