...
- (void)setupConstraints
{
    ...
    if (_customView) {
        CGRect _frame = _customView.frame;
        _frame.origin.x = (self.contentView.frame.size.width - _frame.size.width) / 2;
        _frame.origin.y = (self.contentView.frame.size.height - _frame.size.height) / 2;
        _customView.frame = _frame;
